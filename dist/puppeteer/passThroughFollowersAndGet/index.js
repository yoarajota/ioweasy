...
function passThroughFollowersAndGets(response, page, user) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield page.goto(`https://www.instagram.com/${user}/followers`);
...
exports.default = passThroughFollowersAndGets;
